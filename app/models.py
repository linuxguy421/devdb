...
class WatchEntry(Base):
    ...
    __table_args__ = (
        UniqueConstraint(
            "user_id",
            "media_item_id",
            name="uq_watch_entry_user_media_item",
        ),
        CheckConstraint(
            "status IN ('want_to_watch', 'in_progress', 'watched')",
            name="ck_watch_entry_status_valid",
        ),
        CheckConstraint(
            "(last_watched_season IS NULL AND last_watched_episode IS NULL) "
            "OR "
        ...
        CheckConstraint(
            ...
            name="ck_watch_entry_rating_valid",
        ),
    )
